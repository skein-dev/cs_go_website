...
function GetIpInfoFrmIpinfodbApi($IpLockUp){
	$ResultInfo = array();
	$LinkGetIpDt = "http://api.ipinfodb.com/v3/ip-city/?format=xml&key=56c358ed688a7c2729fa8bbdab5c9fe94de0c68215f6251271c934b6698c7bed&ip=".$IpLockUp."&timezone=true";
